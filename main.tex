...
The verification backend is a direct handoff of the SystemVerilog and SVA code to the SymbiYosys tool for BMC checking.
...
Both are used as components of the rvfi\_wrapper module.
...
Then, the RVFI interface is used as the input of the rvfi\_check module.
% 在 RISC-V Formal 中，实际上包含了有几百个不同的 rvfi_check 模块。
There are actually a few hundred different rvfi\_check modules in RISC-V Formal.
